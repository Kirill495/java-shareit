...
public class UserController {
   ...
   @PostMapping
   public ResponseEntity<OutputUser> createUser(@RequestBody NewUserRequest request) {
   ...
   @PatchMapping("/{userId}")
   public OutputUser updateUser(@PathVariable Integer userId, @RequestBody UpdateUserRequest request) {
      return userMapper
